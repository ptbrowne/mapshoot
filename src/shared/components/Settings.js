...
class _Settings extends React.Component {
  ...
  render () {
    ...
    return <div>
      <h3>mapbox</h3>
      login <input
        onChange={ this.handleChangeSetting.bind(this, 'mapboxLogin') } value={ mapboxLogin }/><br/>
      map id <input
        onChange={ this.handleChangeSetting.bind(this, 'mapboxMapId') } value={ mapboxMapId }/><br/>
      access token <input
        onChange={ this.handleChangeSetting.bind(this, 'mapboxAccessToken') } value={ mapboxAccessToken }/><br/>
      { shouldSave ?
        <button
